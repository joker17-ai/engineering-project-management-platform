...
export function createBlankProjectTree(projectName = '新建工程项目') {
  return {
    id: `blank-root-${slugProjectId(projectName)}`,
    name: projectName,
    type: '项目',
    status: '待导入资料',
    children: [
      {
        id: `blank-bid-${slugProjectId(projectName)}`,
        name: '第一标段',
        type: '标段',
        status: '待导入资料',
        children: [],
...
function slugProjectId(value) {
  return encodeURIComponent(value).replaceAll('%', '').toLowerCase().slice(0, 24) || 'new-project';
}
...
export const mockDatabaseConnections = [
  {
    ...
    acceptedFiles: ['PNG', 'JPG', 'DWG', 'DOCX', 'DOC', 'XLS', 'XLSX', 'CSV', 'SHP', 'GeoJSON', 'KML', 'ZIP', 'Word', 'PPT', 'PPTX'],
    status: '已建立虚拟库',
  ...
  },
  {
    ...
    acceptedFiles: ['PDF', 'DWG', 'JPG', 'PNG', 'ZIP'],
    status: '可手动上传',
  ...
  },
  {
    ...
    acceptedFiles: ['PDF', 'DOC', 'DOCX', 'Word', 'PPT', 'PPTX', 'XLS', 'XLSX', 'CSV', 'ZIP'],
    status: '可手动上传',
  ...
  },
  {
    ...
    acceptedFiles: ['PDF', 'DOCX', 'XLS', 'XLSX', 'CSV', 'JPG', 'PNG', 'ZIP'],
    status: '可手动上传',
  ...
  },
  {
    ...
    acceptedFiles: ['XLS', 'XLSX', 'CSV', 'ZIP'],
    status: '可手动上传',
  ...
  },
  {
    ...
    acceptedFiles: ['SHP', 'GeoJSON', 'KML', 'XLSX', 'CSV', 'ZIP'],
    status: '字段预留',
